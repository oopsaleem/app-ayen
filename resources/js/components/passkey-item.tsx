    ...
    return (
        <div className="flex items-center justify-between border-b p-4 last:border-b-0">
            ...
            <Dialog>
                ...
                <DialogContent>
                    <DialogTitle>
                        {t('settings.security.passkeys.remove_passkey')}
                    </DialogTitle>
                    <DialogDescription>
                        {t('settings.security.passkeys.remove_confirm', {
                            name: passkey.name,
                        })}
                    </DialogDescription>
                    <DialogFooter className="gap-2">
                        ...
                        >
                            {isDeleting
                                ? t('settings.security.passkeys.removing')
                                : t(
                                      'settings.security.passkeys.remove_passkey',
                                  )}
                        </Button>
                    </DialogFooter>
                </DialogContent>
